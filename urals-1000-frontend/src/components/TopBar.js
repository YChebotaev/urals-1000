      ...
      <div className="TopBar">
        ...
        >
          ...
          <Nav pullRight>
            ...
            <NavItem href="/summits" active={this.isActive("/summits")}>
              Вершины
            </NavItem>
            <NavItem href="/climbs" active={this.isActive("/climbs")}>
              Восходители
            </NavItem>
            <NavItem href="/about" active={this.isActive("/about")}>
              О проекте
            </NavItem>
            <NavItem href="/profile" active={this.isActive("/profile")}>
              Профиль
            </NavItem>
          </Nav>
        </Navbar>
